...
const faviconMapper: { [key: string]: string } = {
  '((?:zolplay.cn)|(?:zolplay.com)|(?:cn.zolplay.com))':
    'https://nikdev.cn/favicons/zolplay.png',
  '(?:github.com)': 'https://nikdev.cn/favicons/github.png',
  '((?:t.co)|(?:twitter.com)|(?:x.com))':
    'https://nikdev.cn/favicons/twitter.png',
  'coolshell.cn': 'https://nikdev.cn/favicons/coolshell.png',
  'vercel.com': 'https://nikdev.cn/favicons/vercel.png',
  'nextjs.org': 'https://nikdev.cn/favicons/nextjs.png',
}
...
export async function GET(req: NextRequest) {
  ...
  let iconUrl = 'https://nikdev.cn/favicon_blank.png'
